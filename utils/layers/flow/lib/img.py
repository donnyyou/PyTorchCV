...
# flow lib for img level operation
...
import numpy as np
from utils.layers.flow.lib.io import read_flow
UNKNOWN_FLOW_THRESH = 1e7
SMALLFLOW = 0.0
LARGEFLOW = 1e8
# note this is numpy implementation
...
def warp_image(im, flow):
    """
    Use optical flow to warp image to the next, note this is numpy implementation
